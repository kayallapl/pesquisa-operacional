...
def vizinho_mais_proximo(origem, destinos):
    caminho = [origem]
    distancia_total = 0
...
# Lista de destinos
destinos = [cidade_B, cidade_C, cidade_D, cidade_E, cidade_F, cidade_G, cidade_H, cidade_I, cidade_J, cidade_K, cidade_L, cidade_M]

# Execução do vizinho mais próximo
caminho, distancia_total = vizinho_mais_proximo(origem, destinos)
